...
<style>
    ...
    .source-legend { font-size: 12px; color: #666; margin-top: 10px; border-top: 1px solid #333; padding-top: 10px; }
</style>
...
with c_tempo:
    # Mapeamento do tempo visual para o tempo técnico
...
with c_btn:
    ...
    if st.button("▶ INICIAR", use_container_width=True):
        ...
        st.toast(f"Analisando {simbolo_tecnico} em {tempo_selecionado}...")
    st.markdown('</div>', unsafe_allow_html=True)

st.divider()

# --- 5. LÓGICA DE DADOS (Agora recebe o Timeframe) ---
# Passamos o timeframe_tecnico para o serviço
